...
export const I18N = {
  en: {
    popup: {
      ...
      account: 'Account',
      ariaAccount: 'Account — opens dashboard to sign in',
    ...
    dashboard: {
      ...
      accountLoginSubtitle:
        'Sign in to track your email extraction usage. Full server authentication will connect here later.',
      accountEmail: 'Email',
      ...
      ariaAccount: 'Account — sign in or view email usage',
    },
  },
};
