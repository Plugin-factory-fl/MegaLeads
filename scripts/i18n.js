...
export const I18N = {
  en: {
    popup: {
      ...
      upgrade: 'Upgrade',
      ariaUpgrade: 'Upgrade — unlimited email extractions (Stripe)',
      account: 'Account',
      ...
      authBannerBody: 'Sign up once on the MegaLeads page to use the free tier (tracked unique emails, up to 500).',
      authBannerCta: 'Create free account',
      atCapBannerTitle: 'Free email limit reached',
      atCapBannerBody: 'Subscribe for unlimited Instagram email extractions.',
      atCapBannerCta: 'Upgrade',
      statusNeedsAccount: 'Create an account before starting extraction.',
      statusAtCap: 'You have reached the 500 free unique emails limit. Upgrade to continue.',
    },
    signup: {
      pageTitle: 'MegaLeadsAI — Create your account',
      heroTitle: 'Create your MegaLeadsAI account',
      heroLead:
        'One free account ties your device to the free tier: up to 500 unique emails extracted, then upgrade for unlimited access.',
      createTitle: 'Sign up',
    ...
    dashboard: {
      ...
      accountUsageAtCap: 'You have reached the free email limit. Subscribe to continue extracting.',
      accountLogout: 'Sign out',
      accountCheckoutDiamond: 'Unlimited — Stripe',
      ariaCheckoutDiamond: 'Open Stripe checkout to subscribe',
      ...
      capBanner: 'You have used all {cap} free unique emails on this account. Upgrade to continue extracting.',
      startBlockedAtCap: 'Upgrade to start a new extraction — free unique email limit reached.',
      enrichBlockedAtCap: 'Upgrade to run AI enrich — free unique email limit reached.',
    },
  },
};
