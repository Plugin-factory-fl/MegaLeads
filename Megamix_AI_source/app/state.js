...
(function () {
    ...
    const state = {
        ...
        slowedReverbUrl: null,
        /** Slowed + Reverb tweak params (used when re-generating from master) */
        slowedPlaybackRate: 0.8,
        slowedReverbMix: 0.4,
        slowedReverbDecaySeconds: 0.45,
        slowedShimmerDb: 0,
        /** Last Josh changes as human-readable strings for "What Josh did" (kept for API/reply; display uses joshChangeHistory) */
        lastJoshChangesSummary: [],
        /** Full history of Josh applications for "What Josh did" and undo/redo. Each entry is an array of human-readable change strings for one Josh action. */
        joshChangeHistory: []
    };
